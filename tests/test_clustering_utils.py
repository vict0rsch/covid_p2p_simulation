...
class CommonTests(unittest.TestCase):
    ...
    def test_days_offset(self):
        ...
        curr_timestamp = np.uint64(curr_time.timestamp())
        offset_timestamp = np.uint64((curr_time + datetime.timedelta(hours=24)).timestamp())
        self.assertEqual(mu.get_days_offset(curr_timestamp, offset_timestamp), 1.0)
        offset_timestamp = np.uint64((curr_time + datetime.timedelta(hours=12)).timestamp())
        self.assertEqual(mu.get_days_offset(curr_timestamp, offset_timestamp), 0.5)
        offset_timestamp = np.uint64((curr_time + datetime.timedelta(hours=48)).timestamp())
        self.assertEqual(mu.get_days_offset(curr_timestamp, offset_timestamp), 2.0)
        offset_timestamp = np.uint64((curr_time - datetime.timedelta(hours=24)).timestamp())
        self.assertEqual(mu.get_days_offset(curr_timestamp, offset_timestamp), -1.)
    ...
    def test_create_update_message(self):
        ...
        for _ in range(n_trials):
            ...
            encounter_msg = mu.EncounterMessage(
                ...
                encounter_time=np.uint64(fake_encounter_time.timestamp()),
            )
            ...
            update_msg = mu.create_update_message(
                ...
                current_time=np.uint64(fake_update_time.timestamp()),
            )
    ...
    def test_create_updated_encounter_with_message(self):
        ...
        for _ in range(n_trials):
            ...
            update_msg = mu.UpdateMessage(
                ...
                new_risk_level=np.uint8(np.random.randint(mu.risk_level_mask + 1)),
                encounter_time=np.uint64(fake_encounter_time.timestamp()),
                update_time=np.uint64(fake_update_time.timestamp()),
            )
    ...
    def test_find_encounter_match_random(self):
        ...
        for _ in range(n_trials):
            ...
            old_encounter_msg = mu.EncounterMessage(
                uid=mu.create_new_uid(),
                risk_level=np.uint8(np.random.randint(mu.risk_level_mask + 1)),
                encounter_time=np.uint64(old_encounter_time.timestamp()),
            )
            ...
            new_encounter_msg = mu.EncounterMessage(
                uid=mu.create_new_uid(),
                risk_level=np.uint8(np.random.randint(mu.risk_level_mask + 1)),
                encounter_time=np.uint64(new_encounter_time.timestamp()),
            )
...
class MessageTests(unittest.TestCase):
    ...
    def test_simple_negative_encounter(self):
        visits = [
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=False, timestamp=ui(3)),
        ]
        humans = [
    ...
    def test_simple_positive_encounter(self):
        visits = [
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=True, timestamp=ui(3)),
        ]
        humans = [
    ...
    def test_simple_update(self):
        visits = [
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(1), exposition=True, timestamp=ui(4)),
            # 2nd visit used to make sure we populate the message tree beyond the 5-day mark
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(1), exposition=False, timestamp=ui(6)),
        ]
        humans = [
    ...
    def test_chain_updates(self):
        visits = [
            ...
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(1), exposition=False, timestamp=ui(2)),
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(1), exposition=False, timestamp=ui(2)),
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=True, timestamp=ui(4)),
            ...
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=False, timestamp=ui(12)),
        ]
        humans = [
    ...
    def test_multiple_encounters(self):
        visits = [
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=False, timestamp=ui(3)),
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(2), exposition=False, timestamp=ui(3)),
            Visit(visitor_real_uid=ui(2), visited_real_uid=ui(1), exposition=False, timestamp=ui(3)),
            Visit(visitor_real_uid=ui(3), visited_real_uid=ui(0), exposition=False, timestamp=ui(3)),
        ]
        humans = [
            FakeHuman(real_uid=0, exposition_timestamp=never, visits_to_adopt=visits),
            FakeHuman(real_uid=1, exposition_timestamp=never, visits_to_adopt=visits),
    ...
    def test_gen_received_messages(self):
        visits = [
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=False, timestamp=ui(0)),
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=True, timestamp=ui(4)),
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(2), exposition=False, timestamp=ui(6)),
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=False, timestamp=ui(7)),
            Visit(visitor_real_uid=ui(1), visited_real_uid=ui(0), exposition=False, timestamp=ui(8)),
            Visit(visitor_real_uid=ui(0), visited_real_uid=ui(2), exposition=False, timestamp=ui(9)),
        ]
        humans = [
            FakeHuman(real_uid=0, exposition_timestamp=4, visits_to_adopt=visits),  # sick on day 4 (transmission)
            FakeHuman(real_uid=1, exposition_timestamp=1, visits_to_adopt=visits),  # sick on day 1 (random)
